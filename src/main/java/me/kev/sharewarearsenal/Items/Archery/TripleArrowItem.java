...
public class TripleArrowItem extends ArrowItem {

    public TripleArrowItem(Item.Properties p_40512_) {
        super(p_40512_);
    }
    ...
    public void appendHoverText(ItemStack item, @Nullable Level level, List<Component> tooltipComponents, TooltipFlag tooltipFlag) {
        ...
        tooltipComponents.add(Component.translatable("tooltip.sharewarearsenal.triple_arrow").setStyle(Style.EMPTY.withColor(ChatFormatting.BLUE)));
